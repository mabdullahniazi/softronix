      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-6 sm:mb-8 leading-relaxed">
            We're committed to creating high-quality, timeless pieces that are
            made to last. Our sustainable practices include using organic
            materials, ethical manufacturing, and reducing waste at every stage
            of production.
          </p>
